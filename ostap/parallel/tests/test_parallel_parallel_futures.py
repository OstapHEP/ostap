...
from   ostap.parallel.parallel_futures import WorkManager
...
if '__main__' == __name__  or '__builtin__' == __name__ : 
    logger = getLogger ( 'test_parallel_parallel_futures' )
else : 
...
# =============================================================================
## simple    function that creates and  fill a histogram
...
def test_parallel_futures_bare ( ) :
    ...
    with use_canvas ( 'test_parallel_futures_bare' , wait = 1 ) : 
        result.draw (   ) 

    return result

# =============================================================================
## test parallel processing with parallel_futures (task interface) 
def test_parallel_futures_task ( ) :
    """Test parallel processnig with parallel_futures (task interface) 
    """
    logger  = getLogger ("test_parallel_futures_task")
    if not WorkManager :
    ...
    with use_canvas ( 'test_parallel_futures_task' , wait = 1 ) : 
        result.draw (   ) 
        
    return result

# =============================================================================
## test parallel processing with parallel_futures (func interface) 
def test_parallel_futures_func ( ) :
    """Test parallel processnig with parallel_futures (func interface) 
    """
    logger  = getLogger ("test_parallel_futures_func")
    if not WorkManager :
        logger.error ("Failure to import WorkManager")
        return
    ...
    with use_canvas ( 'test_parallel_futures_func' , wait = 1 ) : 
        result.draw (   ) 

    return result

# =============================================================================
## test parallel processing with parallel_futures (use generic task)
def test_parallel_futures_generic ( ) :
    """ Test parallel processnig with parallel_futures (use generic task)
    """
    logger  = getLogger ("test_parallel_futures_generic")
    if not WorkManager :
        logger.error ("Failure to import WorkManager")
        return
    ...
    with use_canvas ( 'test_parallel_futures_generic' , wait = 1 ) : 
        result.draw (   ) 
...
if '__main__' == __name__ :
    ...
    ## bare interface  
    test_parallel_futures_bare    ()
    
    ## task interface  
    test_parallel_futures_task    ()

    ## function interface 
    test_parallel_futures_func    ()
    
    ## use generic task 
    test_parallel_futures_generic ()
