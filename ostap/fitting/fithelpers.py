...
class AsymVars(object) :
    ...
    def __init__ ( self      ,
        ...
        ## (4) two variables are specified, the rest is None  
        ...
        # (5) half-sum and asymmetry :
            ...
            kappa   = self.make_var ( kappa    , kappa_name   , 'asymmetry of %s & %s variables' % ( v1_name , v2_name ) , False , kappa   , -1+1.e-8 , 1-1.e-8 )
