...
__all__ = (
   #
    ...
    'CB2A_pdf'               , ## double-sided Crystal Ball function with asymmetric core
    'CB2E_pdf'               , ## double-sided Crystal Ball function with asymmetric core 
...
if '__main__' ==  __name__ : logger = getLogger ( 'ostap.fitting.signals' )
...
#  @author Vanya BELYAEV Ivan.Belyaev@itep.ru
#  @date 2011-07-25
class CrystalBall_pdf(Gauss_pdf,Tail,LeftTail) :
...
#  @author Vanya BELYAEV Ivan.Belyaev@itep.ru
#  @date 2011-07-25
class CrystalBallRS_pdf(Gauss_pdf,Tail,RightTail) :
...
class DoubleGauss_pdf(Gauss_pdf) :
    ...
    def sigma_scale ( self ) :
        """Scale-parameter for double Gaussian: the ratio of sigmas for the 2nd and 1st Gaussians"""
