// $Id: LHCbMath.cpp 192248 2015-07-21 12:54:46Z ibelyaev $
// ============================================================================
// Include files
// ============================================================================
// STD& STL
...
bool ostap::math::islong ( const double x ) 
{
  return 
    x <= s_MIN_L  ? false :
    x >= s_MAX_L  ? false :
    ostap::math::lomont_compare_double ( x                       , 
                                         ostap::math::round ( x ) , 
                                         mULPS_double            ) ;
}
// ============================================================================
  ...
  const unsigned int mULPS ) 
{
  ...
  return ostap::math::lomont_compare_double ( val , tmp , mULPS ) ;
}
// ============================================================================
...
ostap::math::frexp10 ( const double x ) 
{
  ...
  if      ( 0 < q ) { xa /= ostap::math::pow ( 10.0L , (unsigned long)           q   ) ; }
  else if ( 0 > q ) { xa *= ostap::math::pow ( 10.0L , (unsigned long) -q ) ; }
  //
  if ( 1 <= xa ) { xa /= 10 ; ++q ; }
  //
  return 0 < x ? 
...
double ostap::math::round_N ( const double x , const unsigned short n ) 
{
  ...
  const long    ni = n - 1 ;
  //
  const double  f1 = ostap::math::pow ( 10.0 , ni )  ;
  const double  f2 =
    ni < e ?     ostap::math::pow ( 10.0 , (unsigned long) ( e  - ni ) ) : 
    ni > e ? 1.0/ostap::math::pow ( 10.0 , (unsigned long) ( ni - e  ) ) : 1 ;
//
