...
struct Cast_F {
 ...
 public:
  // ========================================================================
  /// int -> float
  float i2f(const int i) {
    m_f.i = i;
    return m_f.f;
  }  // int   -> float
  /// float -> in
  int f2i(const float f) {
    m_f.f = f;
    return m_f.i;
  }  // float -> int
     // ========================================================================
 ...
 */
// ============================================================================
bool ostap::math::lomont_compare_float(const float af, const float bf,
  ...
  // assert ( (0==test) || ( boost::integer_traits<unsigned int>::const_max ==
  // test ) ) ;

  int diff =
      (((boost::integer_traits<int>::const_min - ai) & (~test)) | (ai & test)) -
      bi;
 ...
 *  the routine ostap::math::lomont_compare
 *
 *  @see ostap::math::lomont_compare
 ...
 */
// ============================================================================
bool ostap::math::lomont_compare_double(const double af, const double bf,
  ...
  Long diff = (((boost::integer_traits<Long>::const_min - ai) & (~test)) |
               (ai & test)) -
              bi;
