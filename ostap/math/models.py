...
for model in ( Ostap.Math.Chebyshev               ,
               ...
               Ostap.Math.Needham                 ,
               Ostap.Math.CrystalBallA            ,
               Ostap.Math.Meixner                 ,
               Ostap.Math.CrystalBallDoubleSided  ,
               Ostap.Math.CrystalBallDoubleSidedA ,
               Ostap.Math.CrystalBallDoubleSidedE ,
               ...
               Ostap.Math.FDistribution          ,
               Ostap.Math.Landau                 ,
               Ostap.Math.JohnsonSU              ,
               Ostap.Math.Atlas                  ,
               Ostap.Math.Sech                   ,
               Ostap.Math.Losev                  ,
               Ostap.Math.GenLogisticIV          ,
               Ostap.Math.FisherZ                ,
               Ostap.Math.BirnbaumSaunders       ,
               Ostap.Math.Frechet                ,
               Ostap.Math.Dagum                  ,
