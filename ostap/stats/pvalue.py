...
class PVALUE (abc.ABC) :
    ...
    def __init__ ( self        ,
        ...
        print ( typename ( self ) ,  w1mean , w2mean )
...
class TOYS (PVALUE) :
    ...
    def __getstate__ ( self ) :
        ...
        """
        ## the base 
        state  = PVALUE.__getstate__ ( self ) ;
    ...
    def __setstate__ ( self , state ) :
        """ De-serialize the object
        """
        PVALUE.__setstate__ ( self , state )
    ...
    def run_toys ( self , nToys , progress = False ) :
        ...
        counter = EffCounter ()
        tvalues = [] 
        for i in progress_bar ( nToys , description = self.description , silent = not progress ) : 
