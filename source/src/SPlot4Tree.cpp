  ...
  , m_result      { std::make_unique<Ostap::Utils::FitResults>( fitresult ) }
{
  ...
  { // ========================================================================
    ...
    // ========================================================================
    Ostap::Utils::Iterator iter_c ( *m_coefs ) ; // only for ROOT < 6.18
    RooAbsArg* c = 0 ;
    while ( c = (RooAbsArg*) iter_c .next() )
      {
        // ====================================================================
#else   // ====================================================================
        // ====================================================================
...
#if ROOT_VERSION_CODE < ROOT_VERSION(6,18,0) // ===============================
    // ========================================================================
    Ostap::Utils::Iterator iter_p ( *fparams ) ; // only for ROOT < 6.18
    RooAbsArg* p = 0 ;
    while ( p = (RooAbsArg*) iter_p .next() )
      {
        // ====================================================================
#else   // ====================================================================
        // ====================================================================
  ...
  const Ostap::Utils::ProgressConf&    progress )
{
  ...
  { // ========================================================================
    ...
    // ========================================================================
    //
    Ostap::Utils::Iterator iter ( the_splot.coefficients ()  ) ; // only for ROOT < 6.18
    const RooAbsArg* c = 0 ;
    while ( c = (RooAbsArg*) iter .next() )
      {
      // =====================================================================
#else // ====================================================================
      // =====================================================================
