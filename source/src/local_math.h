// ============================================================================
#ifndef OSTAP_LOCAL_MATH_H 
#define OSTAP_LOCAL_MATH_H 1
// ============================================================================
// Include files
// ============================================================================
// STD & STL
...
namespace 
{
  ...
  const double s_NONZERO = Ostap::Math::Lomont::next_float ( 0.0f , Ostap::Math::mULPS_float + 1 ) ; 
  // ==========================================================================
