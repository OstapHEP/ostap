...
// Double-sided CrystalBall
// ============================================================================
Ostap::Models::CrystalBallDSE::CrystalBallDSE
( const char*          name      , 
  const char*          title     ,
  RooAbsReal&          x         ,
  RooAbsReal&          m0        ,
...
// ============================================================================
Ostap::Models::CrystalBallDSE::CrystalBallDSE
( const Ostap::Models::CrystalBallDSE& right , 
  const char*                            name ) 
  : RooAbsPdf ( right , name ) 
//
  , m_x       ( "!x"       , this , right.m_x      ) 
...
Ostap::Models::CrystalBallDSE::clone( const char* name ) const 
{ return new Ostap::Models::CrystalBallDSE(*this,name) ; }
// ============================================================================
void Ostap::Models::CrystalBallDSE::setPars () const 
{
  //
  m_cb2.setM0     ( m_m0     ) ;
  m_cb2.setSigma  ( m_sigmaL , m_sigmaR ) ;
...
// the actual evaluation of function 
// ============================================================================
Double_t Ostap::Models::CrystalBallDSE::evaluate() const 
{
  setPars () ;
  return m_cb2     ( m_x      ) ;
}
// ============================================================================
Int_t Ostap::Models::CrystalBallDSE::getAnalyticalIntegral
( RooArgSet&     allVars      , 
  RooArgSet&     analVars     ,
  const char* /* rangename */ ) const 
{
...
// ============================================================================
Double_t Ostap::Models::CrystalBallDSE::analyticalIntegral 
( Int_t       code      , 
  const char* rangeName ) const 
{
  //
...
// ============================================================================
Int_t  Ostap::Models::CrystalBallDSE::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
double Ostap::Models::GenGaussV1::maxVal  ( Int_t      code ) const
{
  ...
  //
  setPars() ;
  return 1.01 * m_ggv1 ( m_ggv1.mode() ) ;
}
// ============================================================================
...
double Ostap::Models::GenGaussV2::maxVal  ( Int_t      code ) const
{
  ...
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::GenGaussV2::maxVal"     ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_ggv2 ( m_ggv2.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::NormalLaplace::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::NormalLaplace::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::NormalLaplace::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  //
  setPars() ;
  return 1.01 * m_nl ( m_nl.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::Novosibirsk::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::Novosibirsk::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::Novosibirsk::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  //
  setPars() ;
  return 1.01 * m_novosibirsk ( m_novosibirsk.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::PolyPositive::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::PolyPositive::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                             ,
                  "Invalid MaxVal code"                 ,
                  "Ostap::Models::PolyPositive::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
...
// ============================================================================
Int_t  Ostap::Models::PolyPositiveEven::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::PolyPositiveEven::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                             ,
                  "Invalid MaxVal code"                 ,
                  "Ostap::Models::PolyPositiveEven::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_even.max_value() ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::PolyMonotonic::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::PolyMonotonic::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                              ,
                  "Invalid MaxVal code"                  ,
                  "Ostap::Models::PolyMonotonic::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_monotonic.max_value() ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::PolyConvex::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::PolyConvex::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                              ,
                  "Invalid MaxVal code"                  ,
                  "Ostap::Models::PolyConvex::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_convex.max_value() ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::PolyConvexOnly::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::PolyConvexOnly::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                              ,
                  "Invalid MaxVal code"                  ,
                  "Ostap::Models::PolyConvexOnly::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_convex.max_value() ;
...
void Ostap::Models::PolySigmoid::setPars () const 
{
  ...
  //
  m_sigmoid.setScale ( m_scale ) ;
  m_sigmoid.setX0    ( m_x0    ) ;
  m_sigmoid.setDelta ( m_delta ) ;
  //
}
// ============================================================================
// the actual evaluation of function 
...
// ============================================================================
Int_t  Ostap::Models::GammaDist::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::GammaDist::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::GammaDist::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_gamma ( m_gamma.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::GenGammaDist::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::GenGammaDist::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::GenGammaDist::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_ggamma ( m_ggamma.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::Amoroso::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::Amoroso::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::Amoroso::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_amoroso ( m_amoroso.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::LogGamma::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::LogGamma::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::LogGamma::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_lgamma ( m_lgamma.mode() ) ;
}
// ============================================================================
...
// ============================================================================
Int_t  Ostap::Models::DoubleGauss::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::DoubleGauss::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::DoubleGauss::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  //
  setPars() ;
...
// ============================================================================
Int_t  Ostap::Models::Gumbel::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::Gumbel::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::Gumbel::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  setPars() ;
  return 1.01 * m_gumbel ( m_gumbel.mode() ) ;
}
// ============================================================================
...
{
  ::copy_real ( shape   ,
		m_shape , "Invalid shape parameters!" ,
                "Ostap::Models::Benini"               ) ;
  //
  Ostap::Assert ( 1 <= ::size ( m_shape )          ,
...
void Ostap::Models::Benini::setPars () const 
{
  ...
  //
  m_benini.setScaleShift ( m_scale , m_shift ) ;
}
// ============================================================================
// the actual evaluation of function 
// ============================================================================
...
// ============================================================================
Ostap::Models::BurrI*
Ostap::Models::BurrI::clone ( const char* name ) const 
{ return new Ostap::Models::BurrI ( *this , name ) ; }
// ============================================================================
void Ostap::Models::BurrI::setPars () const 
{ m_burr.setScaleShift ( m_scale , m_shift ) ; }
// ============================================================================
// the actual evaluation of function 
// ============================================================================
Double_t Ostap::Models::BurrI::evaluate() const 
{
  setPars () ;
  return m_burr ( m_x ) ; 
}
// ============================================================================
Int_t Ostap::Models::BurrI::getAnalyticalIntegral
( RooArgSet&     allVars      , 
  RooArgSet&     analVars     ,
  const char* /* rangename */ ) const 
{
...
// ============================================================================
Double_t Ostap::Models::BurrI::analyticalIntegral 
( Int_t       code      , 
  const char* rangeName ) const 
{
  //
...
// clone 
// ============================================================================
Ostap::Models::BurrXII*
Ostap::Models::BurrXII::clone ( const char* name ) const 
{ return new Ostap::Models::BurrXII ( *this , name ) ; }
// ============================================================================
...
// the actual evaluation of function 
// ============================================================================
Double_t Ostap::Models::BurrXII::evaluate() const 
{
  setPars () ;
  return m_burr ( m_x ) ; 
}
// ============================================================================
Int_t Ostap::Models::BurrXII::getAnalyticalIntegral
( RooArgSet&     allVars      , 
  RooArgSet&     analVars     ,
  const char* /* rangename */ ) const 
{
...
// ============================================================================
Double_t Ostap::Models::BurrXII::analyticalIntegral 
( Int_t       code      , 
  const char* rangeName ) const 
{
  //
...
// ============================================================================
Int_t  Ostap::Models::Meixner::getMaxVal ( const RooArgSet& vars ) const 
{
  RooArgSet dummy{};
  if ( matchArgs ( vars , dummy , m_x ) ) { return 1 ; }
  return 0 ;
...
// ============================================================================
double Ostap::Models::Meixner::maxVal  ( Int_t      code ) const
{
  //
  Ostap::Assert ( 1 == code                       ,
                  "Invalid MaxVal code"           ,
                  "Ostap::Models::Meixner::maxVal" ,
                  INVALID_MAXVAL_CODE             , __FILE__ , __LINE__  ) ;
  //
  //
  setPars() ;
  return 1.01 * m_meixner ( m_meixner.mode() ) ;
}
// ============================================================================
...
ClassImp(Ostap::Models::CrystalBallDSE     ) 
