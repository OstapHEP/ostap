...
if sys.version_info < (2, 6):
    sys.exit("ostap only supports python 2.6 and above")
...
try:
    ...
    sys.exit(
        "{0}\n\n"
        "ostap requires that at least setuptools 0.7 is installed:\n\n"
...
# setup.py can be called from outside the ostap directory
os.chdir(local_path)
